...
export const VolumeLow = () => (
  <svg fill="currentColor" role="presentation" height="16" width="16" aria-label="Volumen bajo" aria-hidden="true"
       id="volume-icon"
       viewBox="0 0 16 16">
    <path
...
export const VolumeMedium = () => (
  <svg fill="currentColor" role="presentation" height="16" width="16" aria-label="Volumen medio" aria-hidden="true"
       id="volume-icon"
       viewBox="0 0 16 16">
    <path
